...
ax.set_title('Comparsion between integraal calculated by simpson and laguerre')
ax.legend()
...
ax1.set_title('Convergence of Laguerre integral with n upto to an accuracy of 4 significant digits')
